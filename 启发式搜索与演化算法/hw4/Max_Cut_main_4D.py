...
class ObjectiveFunction:
    def __init__(self,data,w=None):#w is the weight of objectiv1 functions
        ...
        self.weightList = [self.weightOfGraph1, self.weightOfGraph2, self.weightOfGraph3, self.weightOfGraph4]
