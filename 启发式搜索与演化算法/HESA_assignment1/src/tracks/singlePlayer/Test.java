...
public class Test {
    ...
    public static void main(String[] args) {
		...
		String simpleRandom = "tracks.singlePlayer.simple.simpleRandom.Agent";
...
//		ArcadeMachine.runOneGame(game, l evel1, visuals, sampleRSController, recordActionsFile, seed, 0);
